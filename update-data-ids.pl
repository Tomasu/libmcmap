...
our %metadata = (
	...
	'leaves' => [ 'Oak', 'Spruce', 'Birch', 'Jungle', 'Oak ND', 'Spruce ND', 'Birch ND', 'Jungle ND', 'Oak CD', 'Spruce CD', 'Birch CD', 'Jungle CD', 'Oak ND/CD', 'Spruce ND/CD', 'Birch ND/CD', 'Jungle ND/CD' ],
	'leaves2' => [ 'Acacia', 'Dark Oak', undef, undef, 'Acacia ND', 'Dark Oak ND', undef, undef, 'Acacia CD', 'Dark Oak CD', undef, undef, 'Acacia ND/CD', 'Dark Oak ND/CD', undef, undef ],
	'wool' => \@color_names,
	'carpet' => \@color_names,
	...
	'double_plant' => [ 'Sunflower', 'Lilac', 'Double Tallgrass', 'Large Fern', 'Rose Bush', 'Peony', undef, undef, 'Sunflower Top', 'Lilac Top', 'Tallgrass Top', 'Large Fern Top', 'Rose Bush Top', 'Peony Top' ],
	'piston' => (sub {
